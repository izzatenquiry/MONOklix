  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="text-center">
        <h2 className="text-3xl font-bold">AI Background Remover</h2>
        <p className="text-gray-500 dark:text-gray-400">Instantly remove the background from any image with a single click.</p>
      </div>

      <div className="bg-gray-50 dark:bg-gray-800/50 p-6 rounded-xl shadow-lg space-y-4">
        <ImageUpload id="bg-remover-upload" onImageUpload={handleImageUpload} title="Upload Image to Remove Background"/>
        <button
      ...
      {isLoading && (
        <div className="flex flex-col items-center justify-center text-center p-8 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
          <Spinner />
          <p className="mt-4 text-gray-500 dark:text-gray-400">Removing background... please wait.</p>
        </div>
      )}
      ...
      {resultImage && !isLoading && (
        <div className="mt-6 bg-gray-50 dark:bg-gray-800/50 p-6 rounded-xl space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
            ...
            <div>
              <h4 className="font-semibold text-center mb-2 text-gray-500 dark:text-gray-400">Background Removed</h4>
               <div className="relative group bg-gray-200 dark:bg-gray-700 rounded-lg p-2" style={{backgroundImage: 'repeating-conic-gradient(#e5e7eb 0 25%, transparent 0 50%)', backgroundSize: '16px 16px'}}>
