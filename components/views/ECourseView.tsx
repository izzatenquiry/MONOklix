...
const PlatformUpdatesView: React.FC = () => {
    ...
    return (
        <div className="bg-white dark:bg-neutral-900 p-6 rounded-lg shadow-sm h-full flex flex-col">
            <h2 className="text-xl font-bold mb-4 flex-shrink-0">Platform Updates & Status</h2>
...
const ECourseView: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-12">
      <div>
        <h1 className="text-2xl font-bold sm:text-3xl">Welcome to MONOklix.com</h1>
        <p className="text-neutral-500 dark:text-neutral-400 mt-1">Your all-in-one AI platform. Here are the latest updates and tutorials to get you started.</p>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-neutral-900 p-6 rounded-lg shadow-sm">
            <h2 className="text-xl font-bold mb-4">Getting Started: Main Tutorial</h2>
            ...
            <div className="space-y-3">
              ...
              <button 
                onClick={() => setIsTutorialsVisible(true)}
                className="bg-primary-600 text-white font-semibold py-2 px-5 rounded-lg hover:bg-primary-700 transition-colors text-sm"
              >
