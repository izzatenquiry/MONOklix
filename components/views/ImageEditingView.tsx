  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="text-center">
        ...
        <p className="text-gray-500 dark:text-gray-400">Modify your images with simple text commands.</p>
      </div>
      ...
      {isLoading && (
        <div className="flex flex-col items-center justify-center text-center p-8 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
          <Spinner />
          <p className="mt-4 text-gray-500 dark:text-gray-400">Applying magic edit... this might take a moment.</p>
        </div>
      )}
