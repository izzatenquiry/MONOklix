            ...
            <div>
                ...
                <div className="relative group">
                    ...
                    />
                     <button
                        onClick={handleCopy}
                        className="absolute top-2 right-2 bg-neutral-200 dark:bg-neutral-700 text-neutral-700 dark:text-neutral-200 font-semibold py-1 px-2 rounded-md hover:bg-neutral-300 dark:hover:bg-neutral-600 transition-colors text-xs opacity-0 group-hover:opacity-100"
                    >
                        {copied ? 'Copied!' : 'Copy'}
                    </button>
                </div>
